...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-text-classification/request.json">in the text editor</walkthrough-editor-open-file>.
...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-text-classification/classify-text.py">in the text editor</walkthrough-editor-open-file>, and in the code, **replace `YOUR_PROJECT`** with the name of your project.
