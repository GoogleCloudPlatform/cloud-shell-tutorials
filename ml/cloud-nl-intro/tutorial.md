...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-intro/request2.json">in the text editor</walkthrough-editor-open-file>.
...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-intro/request3.json">in the text editor</walkthrough-editor-open-file>.
...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-intro/request4.json">in the text editor</walkthrough-editor-open-file>.
...
<walkthrough-editor-open-file filePath="cloud-shell-tutorials/ml/cloud-nl-intro/request5.json">in the text editor</walkthrough-editor-open-file>.
